/*
  ...
  1. Rotinas.c  --> "gcc -Id:/biblio/c -Wall -g -c rotinas.c -o rotinas.o"
  2. Graficos.c --> "gcc -Id:/biblio/c -Wall -g -c graficos.c -o graficos.o"
  3. MLivros.c  --> "gcc -Id:/biblio/c -Wall -g -c mlivros.c -o mlivros.o"
  4. MUsuario.c --> "gcc -Id:/biblio/c -Wall -g -c musuario.c -o musuario.o"
  5. MEmprest.c --> "gcc -Id:/biblio/c -Wall -g -c memprest.c -o memprest.o"
  6. MOpcoes.c  --> "gcc -Id:/biblio/c -Wall -g -c mopcoes.c -o mopcoes.o"
  7. biblio.c   --> "gcc -Id:/biblio/c -Wall -g -c biblio.c -o biblio.o"
  8. "gcc -o biblio.exe biblio.o graficos.o memprest.o mlivros.o
      mopcoes.o musuario.o rotinas.o"
