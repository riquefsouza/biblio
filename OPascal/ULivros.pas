...
type
  ...
  TLivros = object(TBiblio)
   ...
   procedure Controles_formLivros(tipo:string;tipo2,pos,col:integer;
...
function TLivros.PesLivros(tipo:char;campo:string;nCod2:integer;sCod2:string;
                   nTamsCod:integer):integer;
var
...
procedure TLivros.formLivros(tipo:integer;titulo,rod:string);
begin
...
procedure TLivros.Limpar_Livros;
begin
   with Livros do
    begin
     Ninsc:=0;
...
procedure TLivros.Rotulos_formLivros(l:integer);
begin
...
procedure TLivros.Controles_formLivros(tipo:string;tipo2,pos,col:integer;
                                       rod:string;foco:boolean);
begin
if tipo='1' then
   begin
...
procedure TLivros.Atribuir_vLivros(limpar:boolean);
begin
...
procedure TLivros.Digita_formLivros;
begin
     with Livros do
      begin
        S:=Titulo;
...
function TLivros.VerificaLivros:boolean;
begin
with Livros do
 begin
  str(Ninsc,S);
...
procedure TLivros.SalvarLivros(tipo:integer);
begin
