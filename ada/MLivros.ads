...
function VerificaLivros return boolean;

-- Declaracao de Procedimentos --

procedure formLivros(tipo: in integer;titulo,rod: in string);
procedure Limpar_Livros; 
procedure Rotulos_formLivros(l: in integer); 
procedure Controles_formLivros(tipo: in string;tipo2,pos,col: in integer;
                               rod: in string;foco: in boolean); 
procedure Atribuir_vLivros(limpar: in boolean); 
procedure Digita_formLivros; 
procedure SalvarLivros(tipo: in integer); 
